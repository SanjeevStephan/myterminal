...
.NOTE
Note that this script assumes that you're running it from the directory where you want to calculate the hashes.
 If you want to calculate the hashes for a different directory, you'll need to modify the Get-ChildItem cmdlet accordingly.
