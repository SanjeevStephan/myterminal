...
$jsonFilePath   = "D:/terminal/matrix/oracle/random_quotes_generator/quotes-of-the-day.ps1" 
$savedJsonPath  = "D:/terminal/matrix/oracle/random_quotes_generator/saved_quotes.json"
#$savedJsonPath = "saved_quotes.json"
