...
$jsonFilePath = "./random-quote-generator.ps1"
...
$testjsonData = Get-Content -Raw -Path "saved_quotes.json" | ConvertFrom-Json
...
& python $HOME\figlet.py --message "Today's Quotes"
