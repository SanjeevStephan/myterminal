...
filename = saved_config_ver_2_0.filename
figlet_display_text = saved_config_ver_2_0.update_table_title
...
if __name__ == "__main__":
    ...
    parser.add_argument("--figlet", type=str, default="pretty-table 2.0", help="Text message to display ")
...
read_full_table_column_header_1 = saved_config_ver_2_0.read_full_table_column_header_1
read_full_table_column_header_2 = saved_config_ver_2_0.read_full_table_column_header_2
read_full_table_column_header_3 = saved_config_ver_2_0.read_full_table_column_header_3

read_full_table_add_row_value_1st = saved_config_ver_2_0.read_full_table_add_row_value_1st
read_full_table_add_row_value_2nd = saved_config_ver_2_0.read_full_table_add_row_value_2nd 
read_full_table_add_row_value_3rd = saved_config_ver_2_0.read_full_table_add_row_value_3rd

read_full_table_sort_by = saved_config_ver_2_0.read_full_table_sort_by
...
def full_table():
    ...
    with open(filename, "r") as file:
        ...
        for operation, values in data.items():
            ...
            table.sortby = saved_config_ver_2_0.read_full_table_sort_by
        print(table)
