$paths  = @{
         ...
         "timetable"      = "D:\terminal\matrix\oracle\timetable"
         "pyscript"        = "D:\pyscripts"
         "pymath"          = "D:\pyscripts\pymath"
         "project"         = "D:\terminal\project"
         "manual"          = "$HOME\Documents\PowerShell\.template"
         "random_math"     = "D:\pyscripts\pymath\random_maths"
         "study"           = "D:\study"
         "alphabet_position" = "D:\study\learn_alphabet_positions"
...
$goto_paths  = @{
         ...
         "study"           = "D:\study"
         "mr_robot"        = "D:\mr_robot"
         "pico"            = "D:\mr_robot\pico_ducky"
         "payload"         = "D:\mr_robot\pico_ducky\payloads"
...
$script = @{
            ...
            "random_math"       = "D:\study\pymaths.bat"
            "check_internet"    = "D:\terminal\taskarray\are-you-online.ps1"
            "google_query"      = "D:\terminal\taskarray\send-google-query.ps1"
            "quotesoftheday"    = "D:\terminal\matrix\oracle\random_quotes_generator\quotes-of-the-day.ps1"
            ...
            "vocabulary"        = "D:\terminal\matrix\oracle\vocabulary\launch-vocabulary.cmd"
            "time_per_ques"     = "D:\terminal\code-snippets\powershell_to_calculate_time_per_ques_to_answer.ps1"
            "showip_status"     = "D:\terminal\py\args_prettytable_ip_status.py"
            "alphabet_position" = "D:\study\alphabet_position.bat"
            "alphabet_reverse_position" = "D:\study\alphabet_reverse_position.bat"
