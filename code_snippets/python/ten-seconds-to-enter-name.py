...
.QUERY
   ask the user name, if the user did not entered anything name him joh
    
.RESPONSE
   You can use the time module to set a timer of 10 seconds for the user to enter their name, and
   then use an if statement to check whether the name is empty. 
   If the name is empty, you can set a default value of "Sam" for the name.
