...
os.system('python D:\\terminal\py\\figlet.py --message "My TODOs"')
# Get the list of Python files in the current directory
files = [file for file in os.listdir('.') if file.endswith('.txt') and file != os.path.basename(__file__)]
...
print("Opening file:", selected_file," in Notepad")
#exec(open(selected_file).read())
os.system("notepad {}".format(selected_file))
